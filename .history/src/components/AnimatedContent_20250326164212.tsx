    ...
    <div className="flex flex-col overflow-hidden pb-[300px]">
      ...
      >
        ...
        <div className="relative w-full h-full">
          {/* Background dashboard image or gradient */}
          ...
          <div className="w-full h-full flex flex-col p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-grow">
              {contentBlocks.map((block, index) => (
                <div
                  key={index}
                  className="p-4 rounded-lg bg-white/10 backdrop-blur-sm border border-white/10 flex flex-col h-full"
                >
                  <div className="text-xl font-semibold mb-2 text-white">{block.title}</div>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={index} className="bg-white/10 p-4 rounded-lg backdrop-blur-sm text-center">
